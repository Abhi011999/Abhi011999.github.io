...
/// app bar, see [SliverAppBar], which embeds an [FrostedAppBar] in a sliver for use in
/// a [CustomScrollView].
///
...
/// English):
///
/// The [FrostedAppBar] insets its content based on the ambient [MediaQuery]'s padding,
/// to avoid system UI intrusions. It's taken care of by [Scaffold] when used in
/// the [Scaffold.appBar] property. When animating an [FrostedAppBar], unexpected
/// [MediaQuery] changes (as is common in [Hero] animations) may cause the content
/// to suddenly jump. Wrap the [FrostedAppBar] in a [MediaQuery] widget, and adjust its
...
///
/// If the [leading] widget is omitted, but the [FrostedAppBar] is in a [Scaffold] with
...
///
/// This sample shows an [FrostedAppBar] with two simple actions. The first action
...
/// See also:
///
///  * [Scaffold], which displays the [FrostedAppBar] in its [Scaffold.appBar] slot.
///  * [SliverAppBar], which uses [FrostedAppBar] to provide a flexible app bar that
///    can be used in a [CustomScrollView].
///  * [TabBar], which is typically placed in the [bottom] slot of the [FrostedAppBar]
...
class FrostedAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  FrostedAppBar({
    ...
    this.blurStrengthX = 10.0,
    this.blurStrengthY = 10.0,
  }) : assert(automaticallyImplyLeading != null),
       assert(elevation == null || elevation >= 0.0),
       assert(primary != null),
       assert(toolbarOpacity != null),
       assert(bottomOpacity != null),
       assert(blurStrengthX != 0 || blurStrengthY != 0),
  ...
  /// [FrostedAppBar] will imply an appropriate widget. For example, if the [FrostedAppBar] is
  /// in a [Scaffold] that also has a [Drawer], the [Scaffold] will fill this
  /// widget with an [IconButton] that opens the drawer (using [Icons.menu]). If
  /// there's no [Drawer] and the parent [Navigator] can go back, the [FrostedAppBar]
  ...
  /// See also:
  ///
  ///  * [Scaffold.appBar], in which an [FrostedAppBar] is usually placed.
  ...
  ///
  /// A flexible space isn't actually flexible unless the [FrostedAppBar]'s container
  /// changes the [FrostedAppBar]'s size. A [SliverAppBar] in a [CustomScrollView]
  /// changes the [FrostedAppBar]'s height when scrolled.
  ///
  ...
  /// null, then [FrostedAppBar] uses the overall theme's [ColorScheme.primary] if the
  ...
  /// value is also null, then [FrostedAppBar] uses the overall theme's
  ...
  /// Defines the height of the toolbar component of an [FrostedAppBar].
  ///
  ...
  /// Blur Strength in x-axis
  /// 
  /// Defaults to 10.0
  final double blurStrengthX;

  /// Blur Strength in y-axis
  /// 
  /// Defaults to 10.0
...
/// the screen see [FrostedAppBar], which is used in the [Scaffold.appBar] slot.
///
...
///    scrolling.
///  * [FrostedAppBar], which is a fixed-height app bar for use in [Scaffold.appBar].
///  * [TabBar], which is typically placed in the [bottom] slot of the [FrostedAppBar]
///    if the screen has multiple pages arranged in tabs.
///  * [IconButton], which is used with [actions] to show buttons on the app bar.
///  * [PopupMenuButton], to show a popup menu on the app bar, via [actions].
...
class SliverAppBar extends StatefulWidget {
  ...
  ///
  /// This property is used to configure an [FrostedAppBar].
  final Widget? leading;
  ...
  /// content is not scrolled under the [FrostedAppBar].
  ///
  /// Defaults to false, meaning that the [elevation] is only applied when the
  /// [FrostedAppBar] is being displayed over content that is scrolled under it.
  ///
